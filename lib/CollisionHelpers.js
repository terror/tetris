...
export const getCollisionDirection = (
  ...
  if (
    topCollisionDistance < bottomCollisionDistance &&
  ...
  if (
    bottomCollisionDistance < topCollisionDistance &&
  ...
  if (
    leftCollisionDistance < rightCollisionDistance &&
  ...
  if (
    rightCollisionDistance < leftCollisionDistance &&
