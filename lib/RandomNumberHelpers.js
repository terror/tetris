...
export const getRandomNegativeNumber = (min, max) =>
...
export const pickRandomElement = (list) =>
  list[getRandomPositiveInteger(0, list.length - 1)];
 ...
 */
export const didSucceedPercentChance = (chance) =>
  getRandomPositiveInteger(1, 100) <= chance * 100;
